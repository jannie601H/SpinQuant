...
For combined optimization and PTQ with reusable rotation checkpoints and independent R3/R4 switches, see [the run_ptq.sh experiment guide](scripts/README_ptq.md).
